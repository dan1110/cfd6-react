          ...
          alternatives like VueJS for simple page interactions."
				...
				<div className="row row-check">
					...
					<div className="col-md-6">
						Được các mentor và các bạn trong team CFD hổ trợ thông qua group CFD Facebook hoặc phần mềm điều
						khiển máy tính.
					</div>
					...
					<div className="teacher">
						...
						<div className="info">
							...
							<p className="intro">
								...
								are also already hard-wired to do some things a bit more "automatically"
							</p>
							<p>
